...
class _WriteExamplesState extends State<WriteExamples> {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  database.child('orders').push().set(nextSO).then((_) => print("Order has been written!"));
                },
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  database.child('products/martelo').push().set(nextSO).then((_) => print("Order has been written!"));
                },
  ...
  String getRandomEquipment() {
    final equipmentList = ['KIT PARAFUSOS', 'PICARETA', 'SERRA', 'MAKITA', 'CAIXA DE FERRAMENTAS', 'MARTELO'];
  ...
  String getRandomPrice() {
    final equipmentPrice = ['150', '85', '310', '309', '200', '160'];
